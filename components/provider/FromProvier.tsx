...
const Context:Context = React.createContext(); // Context 를 만듭니다.
...
const { Provider, Consumer: FormConsumer } = Context;

// Provider 에서 state 를 사용하기 위해서 컴포넌트를 새로 만들어줍니다.
class FormProvider extends React.Component<any,any> {
  state = {
    value: '기본값입니다'
  };
